...
VALUES
    ...
    ('3', 'Alice', 'Johnson', 40, 'Normal_l', NULL),
    ('4', 'Bob', 'Brown', 35, 'Adenoma', '2023-03-20'),
    ('5', 'Charlie', 'White', 45, 'Glioma', '2023-04-30'),
    ('6', 'Douglas', 'Higgins', 50, 'Meningioma', '2023-05-15'),
    ('7', 'Eve', 'Black', 55, 'Normal_l', NULL),
    ('8', 'Frank', 'Green', 60, 'Adenoma', '2023-06-20'),
    ('9', 'Grace', 'Blue', 65, 'Glioma', '2023-07-30'),
    ('10', 'Hank', 'Red', 70, 'Meningioma', '2023-08-15'),
    ('11', 'Ivy', 'Yellow', 75, 'Normal_l', NULL),
    ('12', 'Jack', 'Orange', 80, 'Adenoma', '2023-09-20'),
    ('13', 'Kelly', 'Purple', 85, 'Glioma', '2023-10-30'),
    ('14', 'Liam', 'Pink', 90, 'Meningioma', '2023-11-15'),
    ('15', 'Mia', 'Cyan', 95, 'Normal_l', NULL),
    ('16', 'Noah', 'Magenta', 100, 'Adenoma', '2023-12-20'),
    ('17', 'Olivia', 'Lime', 105, 'Glioma', '2024-01-30'),
    ('18', 'Paul', 'Teal', 110, 'Meningioma', '2024-02-15'),
    ('19', 'Quinn', 'Grey', 50, 'Adenocarcinoma', '2024-03-01'),
    ('20', 'Riley', 'Black', 55, 'Large cell carcinoma', '2024-03-02'),
    ('21', 'Sawyer', 'Green', 60, 'Normal_b', NULL),
    ('22', 'Taylor', 'Blue', 65, 'Squamous cell carcinoma', '2024-03-03'),
    ('23', 'Parker', 'Yellow', 70, 'Adenocarcinoma', '2024-03-04'),
    ('24', 'Morgan', 'Orange', 75, 'Large cell carcinoma', '2024-03-05'),
    ('25', 'Alex', 'Red', 80, 'Normal_b', NULL),
    ('26', 'Jordan', 'Purple', 85, 'Squamous cell carcinoma', '2024-03-06'),
    ('27', 'Avery', 'Pink', 90, 'Adenocarcinoma', '2024-03-07'),
    ('28', 'Casey', 'Teal', 95, 'Large cell carcinoma', '2024-03-08'),
    ('29', 'Skyler', 'Cyan', 100, 'Normal_b', NULL),
    ('30', 'Jamie', 'Magenta', 105, 'Squamous cell carcinoma', '2024-03-09');
GO
